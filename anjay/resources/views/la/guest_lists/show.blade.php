...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $guest_list->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Guest_lists", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/guest_lists/'.$guest_list->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Guest_lists", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.guest_lists.destroy', $guest_list->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/guest_lists') }}" data-toggle="tooltip" data-placement="right" title="Back to Guest lists"><i class="fa fa-chevron-left"></i></a></li>
